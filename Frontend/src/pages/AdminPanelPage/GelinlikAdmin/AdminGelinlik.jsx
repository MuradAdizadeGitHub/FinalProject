...
function AdminGelinlik() {
  ...
  async function handleDeletefotovideo(id) {
    const res = await fetch("http://localhost:3000/gelinlik/" + id, {
      method: "delete",
    });
    const data = await res.json();
    getAllfotovideo();
      ...
      <div className="dashboardgeneral">
        ...
        <div className="dashboardmain">
          <div className="adminpaneltop">
            <p className="adminpaneltophead">Wedding dress rental</p>
